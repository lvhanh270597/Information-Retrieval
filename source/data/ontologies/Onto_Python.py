...
class Ontology:
    ...
    def reasoner(self):
        ...
        for i in range(len(self.words)):
            if 'Name' not in self.onto[self.words[i]]['Data']:
                self.onto[self.words[i]]['Data']['Name'] = self.words[i].replace('_', ' ')
...
a = Ontology.load_from_csv('onto1.csv')
a.deleteWord('số_nguyên')
a.reasoner()
a.save2csv('onto1.csv')
'''
